...
public class UrlController {
    ...
    public UrlController(FindAllUrl findAllUrlUseCase,
  ...
  public ResponseEntity<?> find(
    ...
    public ResponseEntity<?> shortenUrl(
      ...
      UrlDto url_saved =  this.shortenUrlUseCase.run(
        url_req
      );

      HashMap<String, String> errors = url_saved.getErrors();

      if( !url_saved.getErrors().isEmpty()  ){
